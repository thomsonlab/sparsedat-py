...
sdt = sparsedat.Sparse_Data_Table("from_mtx.sdt")
sdt.load()
...
start_time = time.time()
scipy_coo_file = open("scipy_coo.npz", "wb")
...
start_time = time.time()
scipy_coo_file = open("scipy_coo.npz", "rb")
...
start_time = time.time()
scipy_csr_file = open("scipy_csr.npz", "wb")
...
start_time = time.time()
scipy_csr_file = open("scipy_csr.npz", "rb")
scipy_csr_matrix = sparse.load_npz(scipy_csr_file)
scipy_csr_file.close()
a = scipy_csr_matrix.todense()
duration = time.time() - start_time
...
start_time = time.time()
scipy_csc_file = open("scipy_csc.npz", "wb")
...
start_time = time.time()
scipy_csc_file = open("scipy_csc.npz", "rb")
